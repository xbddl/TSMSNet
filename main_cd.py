...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_name', default='Google', type=str) #数据集的路径,位于utils.py文件下的import data_config内部
    ...
    args.baseline_checkpoint_dir = os.path.join(args.baseline_checkpoint_dir, args.project_name)
    os.makedirs(args.baseline_checkpoint_dir, exist_ok=True)
