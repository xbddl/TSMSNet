...
def test(args):
    from models.experience import CDEvaluator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='WHU_best', type=str)
    ...
    parser.add_argument('--data_name', default='WHU', type=str) #数据集的路径,位于utils.py文件下的import data_config内部
